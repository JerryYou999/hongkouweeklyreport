export const schemaStatements = [
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_reports_current_week
    ON reports(iso_year, iso_week) WHERE is_current = 1`,
  `CREATE INDEX IF NOT EXISTS idx_reports_date
    ON reports(report_date DESC)`,
  `CREATE INDEX IF NOT EXISTS idx_reports_sha256
    ON reports(sha256)`,
